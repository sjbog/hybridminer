...
public class AlgoINDIRECT {
	 ...
	 * @throws java.io.IOException exception if there is an error while writing the output file.
	 */
	public List<Itemset> runAlgorithm(StringSequenceDatabaseMaxSP input, String output, double minsup, double ts, double minconf) throws NumberFormatException, IOException {
		...
		SequenceDatabase db = input.getSequenceDB();
		String line;
		...
		for(Sequence seq : db.getSequences()){
			...
			for(List<Integer> uList : seq.getItemsets()){
				line = line + uList.iterator().next()+" ";
			}
		 ...
		 * @throws java.io.IOException exception if there is an error writing the file
		 */
		 ...
		 * @param a the item a
		 * @param b the item b
		 * @throws java.io.IOException exception if error while writing to the output file
		 */
		 ...
		 * @throws java.io.IOException exception if error writing the file
		 */
